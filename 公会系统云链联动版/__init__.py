...
from tooldelta import plugin_entry, Plugin, ToolDelta, TYPE_CHECKING, utils, Player, FrameExit  # noqa: E501
...
from guild_cloud_interop.config_watcher import config_reload_task, refresh_config_file_state  # noqa: E501
...
class GuildPlugin(Plugin):
    ...
    def sync_runtime_config_bindings(self):
        """Apply hot-reloaded config values that are registered outside Config."""  # noqa: E501
    ...
    def on_player_join(self, player: Player):
        ...
        self.game_ctrl.sendcmd(
            f"/scoreboard players add {player_name} {Config.GUILD_SCOREBOARD} 0")  # noqa: E501
