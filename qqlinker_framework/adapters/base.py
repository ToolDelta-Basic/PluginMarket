...
class IFrameworkAdapter(ABC):
    ...
    def register_pre_plugin_api(  # noqa: PYL-R0201
    ...
    def get_pre_plugin_api(self, api_name: str) -> Optional[Any]:  # noqa: PYL-R0201
        """获取已注册的前置插件 API 实例。
    ...
    def get_pre_plugin_apis(self) -> Dict[str, Any]:  # noqa: PYL-R0201
        """返回所有已注册的前置插件 API 字典。"""
        return {}
