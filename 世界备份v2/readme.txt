我们基于差分算法重写了“世界备份”插件，现在我们将具有记录多个时间点的存档的能力。
...
另外几点还需要说明：
1. 由于我们使用单文件数据库储存存档的时间线，所以这将很容易管理数据库文件，至少对于大部分用户而言是这样的
2. 由于 https://github.com/TriM-Organization/bedrock-chunk-diff?tab=readme-ov-file#important，本插件不支持在 Termux 上工作
