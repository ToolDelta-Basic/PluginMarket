...
class _ExtendCodes:
    cmds_cb_map: dict[str, tuple[COMPILER, int]] = {}  # noqa: RUF012
    cmds_exe_map: dict[int, EXECUTOR] = {}  # noqa: RUF012
    counter = 512
...
def compile(code: str, in_namespace: REGISTER):
    ...
    code_block_stack: list[CompiledCode] = [CompiledCode([], at_line=0)]
