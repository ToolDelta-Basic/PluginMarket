...
def get_encoding() -> str:
    """Return the normalized stdin encoding used by the console helpers."""
...
class InteractiveConsole(RawInput, code.InteractiveConsole):
    """Interactive console that renders inbound messages with terminal color."""  # noqa: E501
    ...
    def read(self) -> str:
        """Read the next outbound message from stdin."""
...
class NonInteractive(RawInput):
    ...
    def read(self) -> str:
        """Read the next outbound message without a visible prompt."""
        return self.raw_input("")
...
def main() -> None:  # skipcq: PY-R1000
    ...
    def recv() -> tuple:
        """Receive one websocket frame and normalize control opcodes."""
        try:
            frame = ws.recv_frame()
    ...
    def recv_ws() -> None:
        """Continuously read websocket messages and print them to the console."""  # noqa: E501
        while True:
            opcode, data = recv()
            msg = None
