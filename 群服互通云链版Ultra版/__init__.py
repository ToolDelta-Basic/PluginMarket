...
from .qqbot_mixin import QQLinkerQQBotMixin
...
class QQLinker(
    ...
    author = "大庆油田 / 小六神"
    description = (
        "支持云链与 QQ 官方机器人双通道，提供多群独立管理的群服互通、"
        "QQ群管理员体系和 Orion 联动封禁功能"
    )
    ...
    def __init__(self, frame):
        ...
        self._qqbot_user_openids = {}
        self._qqbot_user_names = {}
        self._qqbot_member_roles = {}
        self.reloaded = False
        ...
        self._ws_retry_stop = threading.Event()
    ...
    def on_def(self):
        ...
        """
        self.load_websocket_dependency()
