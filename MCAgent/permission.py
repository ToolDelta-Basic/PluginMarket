...
class PermissionManager:
    ...
    def check_tool_permission(self, player: Player, tool_name: str) -> Tuple[bool, Optional[str]]:
    ...
    def check_command_safety(self, player: Player, command: str) -> Tuple[bool, Optional[str]]:
        player_level = self.get_player_permission_level(player)
        if player_level == PermissionLevel.FULL:
            return True, None
