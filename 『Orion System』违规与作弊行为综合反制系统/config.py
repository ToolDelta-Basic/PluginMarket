...
class OrionConfig:
    ...
    CONFIG_DEFAULT = {
        ...
        "信息_游戏内私聊(tell,msg,w命令)": {
            "控制台": "§a❀ §f[Text] §c发现 {0} (xuid:{1}) 尝试发送私聊(tell,msg,w命令)，§a正在制裁 §b[TextType:{2}]",
            "游戏内": ["@a", "NN"],
            "玩家": "您尝试发送私聊(tell,msg,w命令)",
        },
        "信息_游戏内me命令": {
            "控制台": "§a❀ §f[Text] §c发现 {0} (xuid:{1}) 尝试发送me命令，§a正在制裁",
            "游戏内": ["@a", "NN"],
            "玩家": "您尝试发送me命令",
        },
        "信息_发言黑名单词检测": {
            "控制台": "§a❀ §f[Text] §c发现 {0} (xuid:{1}) 发送的文本触发了黑名单词({2})，§a正在制裁",
            "游戏内": ["@a", "NN"],
            "玩家": "您发送的文本触发了黑名单词({2})",
        },
        "信息_发言频率检测": {
            "控制台": "§a❀ §f[Text] §c发现 {0} (xuid:{1}) 发送文本速度超过限制({2}条/{3}秒)，§a正在制裁",
            "游戏内": ["@a", "NN"],
            "玩家": "您发送文本速度超过限制({2}条/{3}秒)",
        },
        "信息_发言字数检测": {
            "控制台": "§a❀ §f[Text] §c发现 {0} (xuid:{1}) 发送的文本长度超过{2}字符限制，§a正在制裁",
            "游戏内": ["@a", "NN"],
            "玩家": "您发送的文本长度超过{2}字符限制",
        },
        "信息_重复消息刷屏检测": {
            "控制台": "§a❀ §f[Text] §c发现 {0} (xuid:{1}) 连续发送重复文本超出限制({2}条/{3}秒)，§a正在制裁",
            "游戏内": ["@a", "NN"],
